...
> linter和linter-eslint插件用来检测js语法

> atom-beautify和editorconfig插件都是用来格式化代码
...
> jsbeautifyrc和editorconfig都是用来编写格式化代码规则

> jsbeautifyrc优先级高于editorconfig

> jsbeautifyrc只适用于Atom编辑器,editorconfig适用于所有编辑器(需要安装指定的插件)
